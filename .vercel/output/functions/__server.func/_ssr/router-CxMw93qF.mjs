...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CxMw93qF.js
...
var styles_default = "/assets/styles-C-fAkbKl.css";
var APP_NAME = "עדכון";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "מבזק שעתי של ידיעות בלעדיות מהמזרח התיכון — איראן, לבנון, הציר, המפרציות והזירה הבינלאומית."
			},
			{
				name: "theme-color",
				content: "#0b0c0e"
...
var $$splitComponentImporter = () => import("./routes-CbaR6QY7.mjs");
...
//#endregion
export { refreshTicker as a, getDashboard as i, Route as n, swapSpare as o, ensureBriefing as r, router_exports as t };
